...
void test_program_mode_change() {
  ...
  // Modify some LogicalState value to see if the save/restore is properly trigger on switch
  ...
  TEST_ASSERT_EQUAL(300, logicalState.m_interval);
  TEST_ASSERT_EQUAL(0, logicalState.m_divInterval);
  TEST_ASSERT_EQUAL(300, logicalState.m_tempo);
  ...
  TEST_ASSERT_EQUAL(100, logicalState.m_exprParams[logicalState.m_currentProgram].m_heelValue);
  TEST_ASSERT_EQUAL(800, logicalState.m_exprParams[logicalState.m_currentProgram].m_toeValue);
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][0].m_state);
  TEST_ASSERT_EQUAL(50, logicalState.m_potParams[logicalState.m_currentProgram][0].m_value);
  ...
  TEST_ASSERT_EQUAL(512, logicalState.m_potParams[logicalState.m_currentProgram][1].m_value);
  TEST_ASSERT_EQUAL(256, logicalState.m_potParams[logicalState.m_currentProgram][1].m_minValue);
  TEST_ASSERT_EQUAL(768, logicalState.m_potParams[logicalState.m_currentProgram][1].m_maxValue);
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][2].m_state);
  TEST_ASSERT_EQUAL(100, logicalState.m_potParams[logicalState.m_currentProgram][2].m_value);
  TEST_ASSERT_EQUAL(100, logicalState.m_potParams[logicalState.m_currentProgram][2].m_minValue);
  TEST_ASSERT_EQUAL(800, logicalState.m_potParams[logicalState.m_currentProgram][2].m_maxValue);
  ...
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][0].m_state);
  TEST_ASSERT_EQUAL(300, logicalState.m_potParams[logicalState.m_currentProgram][0].m_value);
  TEST_ASSERT_EQUAL(256, logicalState.m_potParams[logicalState.m_currentProgram][0].m_minValue);
  TEST_ASSERT_EQUAL(512, logicalState.m_potParams[logicalState.m_currentProgram][0].m_maxValue);
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][1].m_state);
  TEST_ASSERT_EQUAL(300, logicalState.m_potParams[logicalState.m_currentProgram][1].m_value);
  TEST_ASSERT_EQUAL(0, logicalState.m_potParams[logicalState.m_currentProgram][1].m_minValue);
  TEST_ASSERT_EQUAL(1023, logicalState.m_potParams[logicalState.m_currentProgram][1].m_maxValue);
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][2].m_state);
  TEST_ASSERT_EQUAL(512, logicalState.m_potParams[logicalState.m_currentProgram][2].m_value);
  TEST_ASSERT_EQUAL(0, logicalState.m_potParams[logicalState.m_currentProgram][2].m_minValue);
  TEST_ASSERT_EQUAL(1023, logicalState.m_potParams[logicalState.m_currentProgram][2].m_maxValue);
  TEST_ASSERT_EQUAL(PotState::kActive, logicalState.m_potParams[logicalState.m_currentProgram][3].m_state);
  TEST_ASSERT_EQUAL(256, logicalState.m_potParams[logicalState.m_currentProgram][3].m_value);
  TEST_ASSERT_EQUAL(0, logicalState.m_potParams[logicalState.m_currentProgram][3].m_minValue);
  TEST_ASSERT_EQUAL(1023, logicalState.m_potParams[logicalState.m_currentProgram][3].m_maxValue);

  // ProgramService sets the pointer to the active program
  TEST_ASSERT_EQUAL("Ducked delay", logicalState.m_activeProgram->m_name);
  ...
  TEST_ASSERT_EQUAL(512, val21);
  mockFv1.m_potValues.pop_back();

  TEST_ASSERT_FALSE(mockFv1.m_potValues.empty());
  auto [pot11, val11] = mockFv1.m_potValues.back();
  TEST_ASSERT_EQUAL(Fv1Pot::Pot1, pot11);
  TEST_ASSERT_EQUAL(300, val11);
  mockFv1.m_potValues.pop_back();
...
int main() {
  UNITY_BEGIN();
  RUN_TEST(test_program_mode_change);
  UNITY_END();
}
