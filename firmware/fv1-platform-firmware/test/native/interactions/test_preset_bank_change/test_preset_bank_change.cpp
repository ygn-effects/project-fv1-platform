...
void fillMockEeprom() {
  ...
  memoryService.handleEvent({EventType::kLoadPresetBank, 0, {.value=4}});

  logicalState.m_currentPreset = 0;
  logicalState.m_currentPresetBank = 4;

  bank.m_presets[0].m_programIndex = 6;
  bank.m_presets[0].m_tapState = TapState::kDisabled;
  bank.m_presets[0].m_divState = DivState::kDisabled;
  bank.m_presets[0].m_divValue = DivValue::kQuarter;
  bank.m_presets[0].m_interval = 0;
  bank.m_presets[0].m_divInterval = 0;
  bank.m_presets[0].m_tempo = 0;
  bank.m_presets[0].m_exprState = ExprState::kInactive;
  bank.m_presets[0].m_mappedPot = MappedPot::kPot0;
  bank.m_presets[0].m_direction = Direction::kInverted;
  bank.m_presets[0].m_heelValue = 0;
  bank.m_presets[0].m_toeValue = 1023;
  bank.m_presets[0].m_potParams[0].m_state = PotState::kActive;
  bank.m_presets[0].m_potParams[0].m_value = 500;
  bank.m_presets[0].m_potParams[0].m_minValue = 0;
  bank.m_presets[0].m_potParams[0].m_maxValue = 1023;
  bank.m_presets[0].m_potParams[1].m_state = PotState::kActive;
  bank.m_presets[0].m_potParams[1].m_value = 128;
  bank.m_presets[0].m_potParams[1].m_minValue = 96;
  bank.m_presets[0].m_potParams[1].m_maxValue = 500;
  bank.m_presets[0].m_potParams[2].m_state = PotState::kActive;
  bank.m_presets[0].m_potParams[2].m_value = 250;
  bank.m_presets[0].m_potParams[2].m_minValue = 200;
  bank.m_presets[0].m_potParams[2].m_maxValue = 700;
  bank.m_presets[0].m_potParams[3].m_state = PotState::kActive;
  bank.m_presets[0].m_potParams[3].m_value = 0;
  bank.m_presets[0].m_potParams[3].m_minValue = 0;
  bank.m_presets[0].m_potParams[3].m_maxValue = 1023;
